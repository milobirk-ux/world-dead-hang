...
// UPDATED FOR CUSTOM FORM SUBMISSIONS SHEET
...
function sendWelcomeEmailOnNewRow(e) {
 ...
 const emailedCol = 17; // Column R: Emailed
 const prCol = 18; // Column S: Is PR
 const previousBestCol = 19; // Column T: Previous Best
 const prBadgeColIndex = 20; // Column U: PR Badge
...
<div style="margin: 20px 0; padding: 15px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px;">
 ...
 // Build enhanced grip age HTML with height and training info
 ...
 gripAgeHtml = `
<div style="margin: 25px 0; padding: 20px; background: linear-gradient(135deg, #e6f7ff, #f0f9ff); border-radius: 8