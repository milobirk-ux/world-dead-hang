// WDHC Email Automation with PR Tracking - v1.6 (Enhanced Design with Correct Tier Colors)
...
<div style="margin: 25px 0; padding: 20px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid ${currentTierColor.border};">
  ...
  <p style="margin: 0; font-size: 1em; line-height: 1.5; color: #333;">
    You're <strong>${formatSecondsToMinutes(gap)}</strong> away from leveling up to the <strong>${nextTier}</strong> tier. Keep training!
  </p>
</div>`;
   }
