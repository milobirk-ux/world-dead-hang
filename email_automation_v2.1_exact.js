/**
 * WDHC Email Automation Script v2.1 - EXACT VERSION
 * 
 * This is the exact script as provided by Milo for editing.
 * Contains enhanced debugging and sophisticated time parsing.
 * 
...
function testColumnStructure() {
    ...
    const weightCol = headers.findIndex(h => h.toString().trim() === 'Body