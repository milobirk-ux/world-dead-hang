// WDHC Email Automation with PR Tracking - v1.9 (Fixed Subject Line Logic)
...
function sendWelcomeEmailOnNewRow(e) {
 ...
 if (gripTrainingColIndex === -1) {
   ...
   activeSheet.getRange(2, gripTrainingColIndex + 1).setValue('Options: Never, Occasional, Regular, Advanced');
 }
