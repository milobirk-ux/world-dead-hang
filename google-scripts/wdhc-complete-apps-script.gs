...
// ==================== EMAIL AUTOMATION ====================
// This is the same function that should already be in your sheet
// Updated to work with Custom Form Submissions sheet
...
function sendWelcomeEmailOnNewRow(e) {
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    // Send email
    sendConfirmationEmail(email, name, timeStr, seconds, age, gender, weight, height, gripTraining, gripAgeResult, isPR);
