// WDHC Google Apps Script - Complete Form Handler + Email Automation v2.3
// For Custom Form Submissions Sheet with Enhanced Grip Age Calculation
// Version 2.3: Fixed CORS headers (setHeaders instead of setHeader)

// ========== FORM HANDLER ==========
function doGet() {
  return ContentService.createTextOutput(JSON.stringify({
    status: 'OK',
    message: 'WDHC Form Handler v2.3 is running',
    version: '2.3'
