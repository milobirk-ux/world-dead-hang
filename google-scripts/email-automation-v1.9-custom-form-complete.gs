...
// UPDATED FOR CUSTOM FORM SUBMISSIONS SHEET - ONLY COLUMN INDICES AND GRIP AGE ENHANCED
...
function sendWelcomeEmailOnNewRow(e) {
 ...
 // ========== UPDATED COLUMN INDICES FOR CUSTOM FORM SUBMISSIONS ==========
...
<div style="margin: 20px 0; padding: 15px; background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px;">
 ...
 if (gripTrainingStr && (gripTrainingStr.includes('none') ||