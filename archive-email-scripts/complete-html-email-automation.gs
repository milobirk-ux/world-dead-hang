// WDHC HTML Email Automation with Advanced Features - COMPLETE FIXED VERSION
// This script sends personalized HTML emails with tier calculations, PR tracking, and accurate time parsing
...
<head>
  ...
  <style>
    ...
    .header { background: linear-gradient(135deg, #1a237e, #283593); color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0; }
    .content { background: white; padding: 20px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 8px 8px; }
    .tier-badge { display: inline-block; background: linear-gradient(135deg, #D4AF37, #FFD700); color: white; padding: 8px 16px; border-radius: 20px; font-weight: bold; margin: 10px 0; }
    .footer { margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; font-size: 0.9em; color: #666; }
    .button { display: inline-block; background: #1a237e; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; margin: 10px 0; }
    .highlight { background: #f9f9f9; padding: 15px; border-left: 4px solid #D4AF37; margin: 15px 0; }
  </style>
</head>
<body>
  <div class="header">
    <h1 style="margin: 0; font-size: 24px;">Welcome to the World Dead Hang Championship!</h1>
    <p style="margin: 10px 0 0 0; opacity: 0.9;">Your grip strength journey begins now</p>
  </div>
  
  <div class="content">
    <h2>Hi ${firstName},</h2>
    
    <p>Thank you for submitting your dead hang time to the World Dead Hang Championship!</p>
    
    ${prMessage}
    
    <div class="highlight">
      <h3 style="margin-top: 0;">📊 Your Submission Details</h3>
      <p><strong>Time:</strong> ${formattedTime} (${time})</p>
      ${age ? `<p><strong>Age:</strong> ${age}</p>` : ''}
      ${gender ? `<p><strong>Gender:</strong> ${gender}</p>` : ''}
      ${weight ? `<p><strong>Weight:</strong> ${weight} lbs</p>` : ''}
    </div>
    
    <div style="text-align: center; margin: 20px 0;">
      <div class="tier-badge">${currentTier} Tier</div>
    ...
    <div style="background: #e8f4fd; padding: 15px; border-radius: 8px; margin: 20px 0;">
      <h3 style="margin-top: 0; color: #1a237e;">💡 Did You Know?</h3>
      <p>${randomBenefit}</p>
    </div>
    
    <div style="text-align: center; margin: 30px 0;">
      <a href="https://worlddeadhang.com" class="button">View Leaderboard</a>
      <a href="https://worlddeadhang.com/rules.html" style="margin-left: 10px; color: #1a237e;">Rules & Guidelines</a>
    </div>
    ...
    <div class="footer">
      ...
      <ul>
        ...
        <li>Once approved, you'll appear on the official leaderboard</li>
        <li>Check your email for updates on your submission status</li>
      </ul>
      
      <p style="margin-top: 20px;">
        Stay strong and keep hanging!<br>
        <strong>The WDHC Team</strong><br>
        World Dead Hang Championship
      </p>
      
      <p style="font-size: 0.8em; color: #999; margin-top: 20px;">
        This is an automated message. Please do not reply to this email.<br>
        Questions? Visit <a href="https://worlddeadhang.com" style="color: #1a237e;">worlddeadhang.com</a>
      </p>
    </div>
  </div>
</body>
...
`;
    ...
    // Send email
    const subject = `Welcome to the World Dead Hang Championship, ${firstName}!`;
    ...
    try {
      ...
      console.log(`HTML email sent to ${name} (${email})`);
