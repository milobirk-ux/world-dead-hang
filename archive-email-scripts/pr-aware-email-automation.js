function sendWelcomeEmailOnNewRow(e) {
  ...
  const prBadgeColIndex = headers.findIndex(h => h.toString().toLowerCase().includes('pr') || h.toString().toLowerCase().includes('personal record'));
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    // Email composition
    const benefits = [
      "Did you know? Hanging for even 10-30 seconds a day decompresses your spine and creates