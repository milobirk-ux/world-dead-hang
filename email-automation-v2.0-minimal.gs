...
// MINIMAL VERSION - ONLY ESSENTIAL CHANGES
// Copy this entire script into Google Apps Script
  ...
  <p style="margin: 0; font-size: 0.95em; color: #555;">
    ...
    if (hasGripAgeData) {
      try {
        ...
        if (heightNum) {
          additionalInfoHtml += `<p style="margin: 5px 0; font-size: 0.9em; color: #666;"><strong>Height:</strong